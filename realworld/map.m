...
H2 = calculateH(img,canvas.plainpoint_uv(5:8,:),canvas.plainpoint_xy(5:8,[2 3 4]),'2.jpg',90,0);
H3 =calculateH(img,canvas.plainpoint_uv(9:12,:),canvas.plainpoint_xy(9:12,[1 3 4]),'3.jpg',90,1);
%imshow(img);
%hold on;
